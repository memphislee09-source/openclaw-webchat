...
- 外观设置：1 套深色 + 5 套浅色主题预设切换与浏览器本地持久化，当前默认浅色方案为 `Dawn Peach`
...
## 已知重点
- 2026-03-18 `0.1.3` 已将代码审查修复、体验修正和历史搜索第一版一起并入 `main`，后续统一以此为基线继续开发
